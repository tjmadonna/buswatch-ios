//
//  PredictionsPresentationPredictionMapper.swift
//  BusWatch
//
...
final class PredictionsPresentationPredictionMapper {

    private let capacityColor: UIColor

    init(capacityColor: UIColor) {
        self.capacityColor = capacityColor
    }

    func mapPredictionArrayToPresentationPredictionArray(_ predictions: [PredictionsPrediction]?)
        -> [PredictionsPresentationPrediction]? {
    ...
    func mapPredictionToDomainPrediction(_ prediction: PredictionsPrediction?) -> PredictionsPresentationPrediction? {
        ...
        return PredictionsPresentationPrediction(
