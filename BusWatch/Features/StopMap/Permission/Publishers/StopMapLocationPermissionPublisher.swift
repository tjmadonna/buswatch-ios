//
//  StopMapLocationPermissionPublisher.swift
//  BusWatch
//
...
struct StopMapLocationPermissionPublisher: Publisher {

    typealias Output = StopMapCurrentLocationPermissionStatus
    ...
    private final class Inner<S>: NSObject, Subscription, CLLocationManagerDelegate
            where S: Subscriber, S.Input == StopMapCurrentLocationPermissionStatus, S.Failure == Never {
        ...
        private func getCurrentLocationPermissionStatus() -> StopMapCurrentLocationPermissionStatus {
