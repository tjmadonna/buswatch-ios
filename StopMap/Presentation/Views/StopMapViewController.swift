...
public final class StopMapViewController: UIViewController {
    ...
    private let style: StopMapStyleRepresentable
    ...
    public init(viewModel: StopMapViewModel, style: StopMapStyleRepresentable) {
    ...
    private func setupObservers() {
        viewModel.state.sink { [weak self] state in
            ...
            case .setLocationBoundsWithStops(let locationBounds, let stops):
                self?.renderSetLocationBoundsWithStopsState(locationBounds, stops)
    ...
    private func renderSetLocationBoundsWithStopsState(_ locationBounds: LocationBounds, _ stops: [Stop]) {
        if locationBounds != mapView.locationBounds {
