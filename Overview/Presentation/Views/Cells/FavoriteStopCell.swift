...
final class FavoriteStopCell: UITableViewCell {
    ...
    func configureWithStop(_ favoriteStop: FavoriteStop, style: FavoriteStopCellStyle) {
...
//        decoratorContainerView.backgroundColor = Colors.decoratorBackgroundColor
//        decoratorLabel.textColor = Colors.decoratorTextBackgroundColor
